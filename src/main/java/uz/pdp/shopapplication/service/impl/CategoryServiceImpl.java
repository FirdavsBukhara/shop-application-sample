...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public CategoryDto createCategory(uz.pdp.shopapplication.dto.CategoryDto dto) {
    ...
    @Override
    public CategoryDto updateCategory(Long id, uz.pdp.shopapplication.dto.CategoryDto dto) {
    ...
    private CategoryDto mapToDto(Category category) {
        return CategoryDto.builder()
                ...
                .products(category.getProducts() == null ? List.of() : category.getProducts().stream()
                        .map(p -> new ProductShortDto(p.getId(), p.getName())).collect(Collectors.toList()))
                .build();
    }
